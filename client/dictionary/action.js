...
export const INTEL_REQUEST__PRIORITY_CHANGE = createActionType('INTEL_REQUEST__PRIORITY_CHANGE');
...
export const UNIT_STATUS__FETCH = createActionType('UNIT_STATUS__FETCH');
export const UNIT_STATUS__ADD = createActionType('UNIT_STATUS__ADD');
