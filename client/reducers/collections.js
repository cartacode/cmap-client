...
export default function collections(state = initialState.collections, {
  payload,
  type,
}) {
  switch (type) {
    ...
    case INTEL_REQUEST__PRIORITY_CHANGE.REQUEST:
      return {
        ...state,
        isFetching: true,
      };
    case INTEL_REQUEST__PRIORITY_CHANGE.SUCCESS:
      return {
        ...state,
        isFetching: false,
        allCollectionsPlan: payload.data,
