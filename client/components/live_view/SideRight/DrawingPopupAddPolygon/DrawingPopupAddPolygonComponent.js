...
import './DrawingPopupAddPolygonComponent.scss';

class DrawingPopupAddPolygonComponent extends React.Component {
        ...
        <div className={'p-3'} style={{background: '#022033'}}>
          ...
          <div className={'d-flex mt-5'}>
            <div className={'w-75 mr-3 flex-column'}>
              ...
              <div className={'mt-4'}>
                <div className={'fs-13 border-bottom-1'}>Area</div>
                <div className={'d-flex mt-3'}>
                  <div className={'mr-2'}>Color:</div>
                  <div className={'mr-3'}><ColorPicker color={'#F10'} /></div>
                  ...
                  <div className={'mr-4 pr-2 ml-1'}>Opacity:</div>
                  <div>
                    <LvSlider
                      value={this.state.sliderPercent}
                      min={1}
...
DrawingPopupAddPolygonComponent.propTypes = {
  showOpen: PropTypes.bool,
  onPopup: PropTypes.func,
};

export default DrawingPopupAddPolygonComponent;
