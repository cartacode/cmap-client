...
import './PopupListingItem.scss';

class PopupListingItem extends React.Component {
...
PopupListingItem.defaultProps = {
  hasColorBall: true,
};

PopupListingItem.propTypes = {
...
export default PopupListingItem;
