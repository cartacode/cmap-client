...
class SigintModal extends React.Component {
  ...
  handlePayloadFeatureData = (featureData) => {
    ...
    this.setState({
      payload: {
        ...
        PayloadChannels: featureData.PayloadChannels,
        PayloadDynamicRange: featureData.PayloadDynamicRange,
  ...
  render() {
    ...
    const payloadFields = [
      {name: 'Frequency Range:', type: 'checkbox', domID: 'PayloadFrequencyRange', valFieldID: 'PayloadFrequencyRange'},
      {name: '#Channels:', type: 'checkbox', domID: 'PayloadChannels', valFieldID: 'PayloadChannels'},
      {name: 'Dynamic Range:', type: 'checkbox', domID: 'PayloadDynamicRange', valFieldID: 'PayloadDynamicRange'},
      {name: 'Maximum Range:', type: 'checkbox', domID: 'PayloadMaximumRange', valFieldID: 'PayloadMaximumRange'},
    ];
            ...
            <div className="row personnel" >
              <div className="header-line">
                ...
                <div className="header-text">
                  sigint payloads administration
                </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(SigintModal);
