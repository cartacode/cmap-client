	...
	render() {
	  ...
	  const columns = [
	    ...
	    },
	    {
		  ...
		  filterable: false,
		  maxWidth: 150,
	      Cell: row => <div><a href="javaScript:void('0');" className="btn btn-primary" onClick={() => this.openPayloadsSpecificationForm(row)} title={translations["Edit"]} ><span className="glyphicon glyphicon-edit"/></a>&nbsp;
                     			 ...
                     			 <a href="javaScript:void('0');" onClick={() => this.deletePayload(row.value)} className="btn btn-danger" title={translations["Delete"]}> <span className="glyphicon glyphicon-trash"/></a>}
	      </div>,
