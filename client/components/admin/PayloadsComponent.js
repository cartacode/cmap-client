	...
	render() {
	  ...
	  },
	  {
	    ...
	    filterable: false,
			...
			Cell: row => <div><a href="#" className="btn btn-primary" onClick={() => this.openPayloadsForm(row.value)} ><span className="glyphicon glyphicon-edit"/></a>&nbsp; <a href="#" onClick={() => this.deletePayloadInventory(row.value)} className="btn btn-danger" > <span className="glyphicon glyphicon-trash"/></a></div>,
