      ...
      },
      {
        ...
        Cell: row => <div><a href="#" className="btn btn-primary btn-sm" onClick={() => this.openPlatformForm(row.value)}  data-tip data-for="Edit" ><span className="glyphicon glyphicon-edit"/>
          ...
          {this.state.editId == row.value ? <span><a href="javaScript:void('0');" className="btn btn-danger action-not-allow"  data-tip data-for="Action Not Allowed" > <span className="glyphicon glyphicon-trash"/></a>
           ...
           <a href="javaScript:void('0');" onClick={() => this.deletePlatformInventory(row.value)} className="btn btn-danger btn-sm"  data-tip data-for="Delete"> <span className="glyphicon glyphicon-trash"/>
