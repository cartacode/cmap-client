...
render() {
  ...
  const columns = [
    ...
    {
      Header: translations['FTN'],
      accessor: 'ftn',
    },
    {
      Header: translations['Operation Name'],
      accessor: 'opName',
    },
    {
      Header: translations['Exercise Name'],
      accessor: 'excerciseName',
    },
    {
  ...
  return (access ? (<div>
    ...
    <div className="row orders-assets">
      ...
      <div className="col-md-12">
        <ReactTable data={allOpords} columns={columns} className="-striped -highlight" filterable={true} defaultPageSize={TableDefaults.PAGE_SIZE} minRows={TableDefaults.MIN_ROWS} loading={this.props.isLoading} defaultFilterMethod={defaultFilter} />
      </div>
    </div>
